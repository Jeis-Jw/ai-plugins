...
wiki-markdown 0.22.0은 이 워크스페이스의 AI-native 위키 메커니즘 정본이다.
...
- cross-plugin proactive recall/승인형 capture 계약(0.21.0) + Claude Code Stop hook capture checkpoint 집행(0.22.0)
...
- hooks: `hooks/capture_checkpoint.py` — Claude Code Stop hook capture checkpoint(0.22.0, `.claude-plugin/plugin.json`에 인라인 선언)
