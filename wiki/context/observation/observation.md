...
- [[OBS-2026-07-26-031054-studio-production-scale-구현-전-남은-admission-reviewer-edge-계측-계약]] — production scale 구현 전에 solo admission 비용 조건, independent reviewer 실행 edge, studio.py 변경 표면, mixed-scale track 계약과 token telemetry를 닫아야 한다.
