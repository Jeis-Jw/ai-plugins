...
- [[OBS-2026-06-12-190117-wiki-cli-다중값-플래그-반복-시-조용히-마지막만-남김]] — capture 등의 --intents/--decisions 같은 다중값 플래그를 반복(--intents a --intents b)하면 argparse last-wins로 앞 값이 에러 없이 드롭됨. 콤마구분(a,b)만 정상. 결정적 CLI 원칙 위반.
